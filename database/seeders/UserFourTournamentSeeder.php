...
class UserFourTournamentSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $teams = collect([
            ['name' => 'Paris Saint-Germain', 'short_name' => 'PSG', 'country' => 'FR', 'logo' => 'teams/psg.png'],
            ['name' => 'Real Madrid', 'short_name' => 'RMA', 'country' => 'ES', 'logo' => 'teams/real.png'],
            ['name' => 'Bayern Munich', 'short_name' => 'BAY', 'country' => 'DE', 'logo' => 'teams/bayern.png'],
            ['name' => 'Manchester City', 'short_name' => 'MCI', 'country' => 'EN', 'logo' => 'teams/city.png'],
            ['name' => 'Barcelona', 'short_name' => 'BAR', 'country' => 'ES', 'logo' => 'teams/barca.png'],
            ['name' => 'Liverpool', 'short_name' => 'LIV', 'country' => 'EN', 'logo' => 'teams/liverpool.png'],
            ['name' => 'Juventus', 'short_name' => 'JUV', 'country' => 'IT', 'logo' => 'teams/juventus.png'],
            ['name' => 'AC Milan', 'short_name' => 'MIL', 'country' => 'IT', 'logo' => 'teams/milan.png']
        ...
        foreach ($otherUsers as $otherUser) {
            TournamentParticipant::firstOrCreate([
                ...
                'registered_at' => Carbon::now()->subHours(rand(1, 24)),
                'status' => 'active'
            ]);
        }
