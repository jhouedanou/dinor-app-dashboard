              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // Événements - d'abord (format mosaïque)
                    ContentGalleryGrid(
                      title: 'Événements',
                      items: _latestEvents,
                      ...
                      maxItems: 6, // Limiter à 6 items sur l'accueil
                    ),

                    const SizedBox(height: 24),

                    // Recettes (format mosaïque)
                    ContentGalleryGrid(
                      title: 'Recettes',
                    ...
                    // Dinor TV - format mosaïque avec thème sombre
                    Container(
